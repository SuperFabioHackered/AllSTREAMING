...
//echo form
echo $form='<form method="post" action="index-checkbox.php"><div class="multiselect"><div class="selectBox" onclick="showCheckboxes()"><select><option>Seleziona le nazioni</option></select><div class="overSelect"></div></div><div id="checkboxes">';
